...
function getShops() {
  return [
  	'SHOP1' => [
            'type' => 'shopify',
            'website' => 'testtesttest123444.myshopify.com',
            'API_key' => '155eaa846bf0cb35f9a09d0b1a8cb602',
            'API_PASS' => 'c97b14c3a84eac258799868095becaaa',
            'shipping' => [
                'premium'=>'USPS Priority Mail',
                'standard'=>'USPS First Class Package'

                ]
        ],
        'SHOP2' =>[
            'type' => 'shopify',
            'website' => 'dummywe1store.myshopify.com',
            'API_key' => '411ab911bb9dfad589dc0e0b2cf0bbd6',
            'API_PASS' => '61c038742e15ee0d5b9be6c5dc3ea484',
            'shipping' => [
                 'premium'=> 'Expedited USPS Priority Mail',
...
// Shipping codes For shopify for testing 
/*
